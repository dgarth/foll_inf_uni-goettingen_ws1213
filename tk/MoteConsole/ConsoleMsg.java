 ...
 * This class implements a Java interface to the 'ConsoleMsg'
 * message type.
 */

public class ConsoleMsg extends net.tinyos.message.Message {
    ...
    /** Create a new ConsoleMsg of size 28. */
    public ConsoleMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new ConsoleMsg of the given data_length. */
    public ConsoleMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ConsoleMsg with the given data_length
     * and base offset.
     */
    public ConsoleMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ConsoleMsg using the given byte array
     * as backing store.
     */
    public ConsoleMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public ConsoleMsg(byte[] data, int base_offset) {
     ...
     */
    public ConsoleMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ConsoleMsg embedded in the given message
     * at the given base offset.
     */
    public ConsoleMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public ConsoleMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
