...
typedef TMilli RelayC__TAckRequest__precision_tag;
...
static void RelayC__relayData__runTask(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void RelayC__TAckRequest__fired(void );
#line 83
...
uint8_t len);
# 59 "/opt/tinyos-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t RelayC__PackAcks__requestAck(
#line 53
message_t * msg);
#line 85
static bool RelayC__PackAcks__wasAcked(
#line 80
message_t * msg);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t RelayC__relayData__postTask(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void RelayC__TAckRequest__startPeriodic(uint32_t dt);
# 68 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t RelayC__AMPacket__address(void );
#line 136
static bool RelayC__AMPacket__isForMe(
#line 133
message_t * amsg);
# 6 "NodeTools.nc"
static void RelayC__Tools__perror(error_t err, const char *failmsg, const char *msg);
#line 5
static void RelayC__Tools__flashLed(uint8_t led, uint8_t times);
#line 4
static void RelayC__Tools__setLed(uint8_t led, bool on);
# 35 "RelayC.nc"
enum RelayC____nesc_unnamed4310 {
#line 35
  RelayC__relayData = 0U
};
#line 35
typedef int RelayC____nesc_sillytask_relayData[RelayC__relayData];
#line 30
message_t RelayC__pingPacket;
message_t RelayC__dataPacket;

am_addr_t RelayC__relayTarget;
...
static inline void RelayC__TAckRequest__fired(void );
#line 83
static void RelayC__AMSend__sendDone(message_t *msg, error_t error);
#line 107
static inline message_t *RelayC__Receive__receive(message_t *msg, void *payload, uint8_t len);
#line 149
static inline void RelayC__relayData__runTask(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x40835840){
#line 39
  switch (arg_0x40835840) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x40835840);
#line 39
      break;
#line 39
    }
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40a20730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x40a20730, addr, msg, len);
#line 80
...
inline static bool RelayC__PackAcks__wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
#line 85
# 4 "NodeTools.nc"
inline static void RelayC__Tools__setLed(uint8_t led, bool on){
#line 4
...
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t RelayC__relayData__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(RelayC__relayData);
#line 67
...
inline static bool RelayC__AMPacket__isForMe(message_t * amsg){
#line 136
  unsigned char __nesc_result;
#line 136
...
#line 126
# 5 "NodeTools.nc"
inline static void RelayC__Tools__flashLed(uint8_t led, uint8_t times){
#line 5
...
#line 108
  ...
  RelayC__Tools__flashLed(2, 1);
  pmsg = (RFMessage *)payload;
  prelay = (RFMessage *)RelayC__Packet__getPayload(&RelayC__dataPacket, sizeof(RFMessage ));


  if (!RelayC__AMPacket__isForMe(msg)) {
      printf("Relay: Packet not for me\n");
#line 117
      printfflush();
      return msg;
    }
  ...
  switch (__nesc_ntoh_uint8(pmsg->control.nxdata)) {
      case 1: 
        printf("Relay: Echo request from node %d.\n", __nesc_ntoh_uint8(pmsg->sender.nxdata));
#line 124
      printfflush();
      break;
      case 2: 
        __nesc_hton_uint8(prelay->control.nxdata, 2);
      RelayC__relayTarget = 10;
      RelayC__relayData__postTask();
      break;
      case 4: 
        __nesc_hton_uint8(prelay->control.nxdata, 4);
      RelayC__relayTarget = 10;
      RelayC__relayData__postTask();
      printf("Relaying data: Node %d --> %d, RSSI = %d.\n", __nesc_ntoh_uint8(pmsg->data1.nxdata), __nesc_ntoh_uint8(pmsg->data2.nxdata), __nesc_ntoh_int8(pmsg->data3.nxdata));
#line 135
      printfflush();
      break;
      case 8: 
...
# 6 "NodeTools.nc"
inline static void RelayC__Tools__perror(error_t err, const char *failmsg, const char *msg){
#line 6
...
#line 63
{
  RelayC__Tools__perror(error, "AMControl.stopDone", "RF chip power down succeeded.\n");
}
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void RelayC__TAckRequest__startPeriodic(uint32_t dt){
#line 64
...
#line 50
{
  RelayC__Tools__perror(error, "AMControl.startDone", "RF chip initialized.\n");


  if (error == SUCCESS) {

      RelayC__Tools__flashLed(4, 2);


      RelayC__TAckRequest__startPeriodic(5000);
    }
}
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t RelayC__PackAcks__requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
# 68 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t RelayC__AMPacket__address(void ){
#line 68
  unsigned int __nesc_result;
#line 68
...
#line 68
{
  ...
  pmsg = (RFMessage *)RelayC__Packet__getPayload(&RelayC__pingPacket, sizeof(RFMessage ));
  __nesc_hton_uint8(pmsg->sender.nxdata, RelayC__AMPacket__address());
  __nesc_hton_uint8(pmsg->control.nxdata, 1);

  RelayC__Tools__flashLed(1, 1);
  RelayC__PackAcks__requestAck(&RelayC__pingPacket);
  result = RelayC__AMSend__send(10, &RelayC__pingPacket, sizeof(RFMessage ));
  RelayC__Tools__perror(result, "TAckRequest.fired", "Relay: ACK requested\n");
}
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x40a20730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40a20730, addr, msg, len);
#line 80
...
#line 149
{
  ...
  pmsg = (RFMessage *)RelayC__Packet__getPayload(&RelayC__dataPacket, sizeof(RFMessage ));
  __nesc_hton_uint8(pmsg->sender.nxdata, 9);
  result = RelayC__AMSend__send(RelayC__relayTarget, &RelayC__dataPacket, sizeof(RFMessage ));

  if (result != SUCCESS) {
      RelayC__Tools__perror(result, "task relayData", "Packet relayed.");
    }
}
...
#line 39
  ...
  if (RelayC__AMPacket__address() != 9) {
      printf("WARN: RELAY_ID and current address do not match!\n");
#line 45
      printfflush();
    }
}
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x40835840){
#line 39
  switch (arg_0x40835840) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x40835840);
#line 39
      break;
#line 39
    }
...
#line 75
    case RelayC__relayData:
#line 75
      RelayC__relayData__runTask();
#line 75
      break;
#line 75
...
#line 83
{
  ...
  RelayC__Tools__perror(error, "AMSend.sendDone", "");
  pmsg = (RFMessage *)RelayC__Packet__getPayload(msg, sizeof(RFMessage ));
...
#line 90
  ...
  switch (__nesc_ntoh_uint8(pmsg->control.nxdata)) {
      case 1: 
        if (RelayC__PackAcks__wasAcked(msg)) {
            RelayC__Tools__setLed(4, TRUE);
          }
        else 
#line 98
          {
            RelayC__Tools__setLed(4, FALSE);
          }
      break;
    }
}
